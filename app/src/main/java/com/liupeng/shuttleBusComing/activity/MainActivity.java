...
public class MainActivity extends CheckPermissionsActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationBar
                .addItem(new BottomNavigationItem(R.drawable.navigation_map, "首页").setActiveColorResource(R.color.greeny))
                .addItem(new BottomNavigationItem(R.drawable.navigation_bus, "路线").setActiveColorResource(R.color.greeny))
                .addItem(new BottomNavigationItem(R.drawable.navigation_me, "我").setActiveColorResource(R.color.greeny))
