...
public class MainActivity extends CheckPermissionsActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationBar
                .addItem(new BottomNavigationItem(R.drawable.navigation_map, "地图").setActiveColorResource(R.color.blue))
                .addItem(new BottomNavigationItem(R.drawable.navigation_bus, "班车").setActiveColorResource(R.color.blue))
                .addItem(new BottomNavigationItem(R.drawable.navigation_me, "我").setActiveColorResource(R.color.blue))
